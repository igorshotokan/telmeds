...
<h2><a href="<?php the_permalink();?>"><?php the_title(); ?></a></h2>
<a href="<?php the_permalink();?>"><img src="<?php bloginfo('template_directory'); ?>/scripts/timthumb.php?src=<?php echo get_post_meta($post->ID, 'IP_poster', true); ?>&amp;zc=1&amp;w=220&amp;h=280&amp;q=75&amp;a=t" alt="<?php the_title();?>" width="220" height="260" style="margin: 0pt auto; display: block;" /></a>
<?php endwhile; ?>
</div>
