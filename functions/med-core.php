...
function additional_admin_bar_menu( $wp_admin_bar ) {
	...
	if (current_user_can('subir_subir') === true){
		$wp_admin_bar->add_menu( array( 'title' => 'Subir', 'href' => 'http://www.telmeds.org/subir' ) );
	}
	if (current_user_can('subir_ver') === true){
		$wp_admin_bar->add_menu( array( 'title' => 'Ver clases', 'href' => 'http://www.telmeds.org/ver' ) );
	}
	if (current_user_can('cmcn') === true){
		$wp_admin_bar->add_menu( array( 'title' => 'Ver Inscripciones', 'href' => 'http://www.telmeds.org/cmcn2013admin' ) );
	}
}
